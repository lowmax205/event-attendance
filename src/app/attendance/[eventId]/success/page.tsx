...
export default async function AttendanceSuccessPage({
  ...
  > = {
    ...
    Disputed: {
      ...
      description:
        attendance.disputeNote ||
        "Your attendance is under dispute. Please contact a moderator for more information.",
    },
  };

  const status = statusConfig[attendance.verificationStatus];
    ...
    <div className="container max-w-3xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        ...
        <Button asChild variant="outline" size="lg">
          <Link href="/attendance">Scan Another Event</Link>
        </Button>
      </div>
